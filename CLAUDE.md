...
- Adam — sales. Isaac's read: strong closer. Intended to sell the concierge offering broadly.
  **Born in Boca, has lived in the condo 10–15 years, knows everyone in town.** His network is the
  distribution channel, not a nice-to-have.
...
- Jared — Isaac's condo contractor and best friend. High-ticket local trade, referral-driven, almost
  certainly has no decent client-facing material. Likely the strongest candidate for a first *paying*
  concierge client, and trusted enough to give an honest verdict rather than a polite yes.
